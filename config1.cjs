...
const config = {
  SESSION_ID: process.env.SESSION_ID || "HAIKO~MDX~yMgUTIrT#umHFaZg5BFCI0whhZHhnN6ZcUiI_CHi6unvpEQaAFGo",
  ...
  BOT_NAME: process.env.BOT_NAME || "MR AFRIKEN UNLOCKER",
  MENU_IMAGE: process.env.MENU_IMAGE || "https://files.catbox.moe/pcb7ya.jpg",
  DESCRIPTION: process.env.DESCRIPTION || "WELCOME TO MR AFRIKEN UNLOCKER PRO",
